...
class SharePointClient:
    ...
    async def upload_file(self, local_path: str, sharepoint_folder: str, filename: str) -> bool:
        ...
        try:
            ...
            # Get target folder
            folder = self.context.web.get_folder_by_server_relative_url(sharepoint_folder)
